...
// export default function CameraTracker() {
//   const localVideoRef = useRef(null);
//   const pcsRef = useRef({}); // key: adminSocketId
//   const streamRef = useRef(null);
...
//               targetSocketId: adminSocketId,
//               candidate: e.candidate,
//               userId: user.id, // send employee id
//             });
//           }
//         };
...
//     // Handle answer from admin
//     socket.on("webrtc-answer", async ({ answer, adminSocketId }) => {
//       const pc = pcsRef.current[adminSocketId];
//       if (pc && !pc._remoteSet) {
//         await pc.setRemoteDescription(new RTCSessionDescription(answer));
//         pc._remoteSet = true;
//       }
...
//     socket.on("webrtc-ice", async ({ candidate, adminSocketId }) => {
//       const pc = pcsRef.current[adminSocketId];
//       if (pc && candidate) {
//         try {
//           await pc.addIceCandidate(new RTCIceCandidate(candidate));
